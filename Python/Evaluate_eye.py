...
class Dataset:
    def __init__(self):
        ...
        for l in range(self.langnum):
            ...
            embeddings[l][:,self.w2v_dim*l:self.w2v_dim*(l+1)] = src_embs
...
if 'logger':
    ...
    if params.method == 'dtw':
        ...
        logging.basicConfig(filename='log/{}/{}/c{}_sl{}_wd{}/swap{}_vr{}_l2-{}_l0-{}_del-{}_l1-{}_mv{}.log'.format(dataset.dataname,params.method,params.classnum,params.seqlen,params.w2v_dim,params.swap,params.v_rate,params.lambda2,params.lambda0,params.delta,params.lambda1,params.max_vocab), format="%(message)s", filemode='w') # ログのファイル出力先を設定

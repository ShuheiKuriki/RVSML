...
def build_model(params, src_data, tgt_data, with_dis):
    """
    ...
    _src_emb = torch.mm(_src_emb, src_data.trans_mat)
    params.emb_dim = src_data.trans_mat.shape[1]
    ...
    if params.tgt_lang:
        ...
        _tgt_emb = torch.mm(_tgt_emb, tgt_data.trans_mat)
        params.emb_dim = tgt_data.trans_mat.shape[1]
